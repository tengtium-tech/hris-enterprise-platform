...
/// direct static call." Every handler under test here already takes
/// <see cref="TimeProvider"/> through constructor injection; this is the fixed value
/// tests inject instead of <see cref="TimeProvider.System"/>.
/// </summary>
